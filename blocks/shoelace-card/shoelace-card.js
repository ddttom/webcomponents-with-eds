 ...
 */
const tt = globalThis, gt = tt.ShadowRoot && (tt.ShadyCSS === void 0 || tt.ShadyCSS.nativeShadow) && "adoptedStyleSheets" in Document.prototype && "replace" in CSSStyleSheet.prototype, ft = Symbol(), Et = /* @__PURE__ */ new WeakMap();
let jt = class {
  constructor(t, o, r) {
...
}, At = gt ? (e) => e : (e) => e instanceof CSSStyleSheet ? ((t) => {
  let o = "";
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const { is: be, defineProperty: ge, getOwnPropertyDescriptor: fe, getOwnPropertyNames: ve, getOwnPropertySymbols: ye, getPrototypeOf: we } = Object, k = globalThis, St = k.trustedTypes, xe = St ? St.emptyScript : "", _e = k.reactiveElementPolyfillSupport, R = (e, t) => e, rt = { toAttribute(e, t) {
  switch (t) {
    case Boolean:
      e = e ? xe : null;
      break;
  ...
  return o;
} }, vt = (e, t) => !be(e, t), zt = { attribute: !0, type: String, converter: rt, reflect: !1, useDefault: !1, hasChanged: vt };
...
let T = class extends HTMLElement {
  ...
  static getPropertyDescriptor(t, o, r) {
    const { get: s, set: l } = fe(this.prototype, t) ?? { get() {
      return this[o];
    }, set(a) {
      this[o] = a;
    } };
    return { get: s, set(a) {
      const i = s?.call(this);
      l?.call(this, a), this.requestUpdate(t, i, r);
  ...
  static finalize() {
    ...
    if (this.finalized = !0, this._$Ei(), this.hasOwnProperty(R("properties"))) {
      const o = this.properties, r = [...ve(o), ...ye(o)];
  ...
  static finalizeStyles(t) {
    ...
    if (Array.isArray(t)) {
      ...
      for (const s of r) o.unshift(At(s));
    } else t !== void 0 && o.push(At(t));
    return o;
  }
  static _$Eu(t, o) {
    const r = o.attribute;
  ...
  _$ET(t, o) {
    ...
    if (s !== void 0 && r.reflect === !0) {
      const l = (r.converter?.toAttribute !== void 0 ? r.converter : rt).toAttribute(o, r.type);
  ...
  _$AK(t, o) {
    ...
    if (s !== void 0 && this._$Em !== s) {
      const l = r.getPropertyOptions(s), a = typeof l.converter == "function" ? { fromAttribute: l.converter } : l.converter?.fromAttribute !== void 0 ? l.converter : rt;
  ...
  performUpdate() {
    ...
    if (!this.hasUpdated) {
      ...
      if (r.size > 0) for (const [s, l] of r) {
        const { wrapped: a } = l, i = this[s];
        a !== !0 || this._$AL.has(s) || i === void 0 || this.C(s, void 0, l, i);
      }
    }
    let t = !1;
    const o = this._$AL;
...
T.elementStyles = [], T.shadowRootOptions = { mode: "open" }, T[R("elementProperties")] = /* @__PURE__ */ new Map(), T[R("finalized")] = /* @__PURE__ */ new Map(), _e?.({ ReactiveElement: T }), (k.reactiveElementVersions ?? (k.reactiveElementVersions = [])).push("2.1.0");
/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */
const V = globalThis, st = V.trustedTypes, Lt = st ? st.createPolicy("lit-html", { createHTML: (e) => e }) : void 0, qt = "$lit$", $ = `lit$${Math.random().toFixed(9).slice(2)}$`, Wt = "?" + $, $e = `<${Wt}>`, S = document, q = () => S.createComment(""), W = (e) => e === null || typeof e != "object" && typeof e != "function", yt = Array.isArray, ke = (e) => yt(e) || typeof e?.[Symbol.iterator] == "function", ct = `[ 	
\f\r]`, N = /<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g, Tt = /-->/g, Mt = />/g, C = RegExp(`>|${ct}(?:([^\\s"'>=/]+)(${ct}*=${ct}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`, "g"), Pt = /'/g, It = /"/g, Gt = /^(?:script|style|textarea|title)$/i, Ce = (e) => (t, ...o) => ({ _$litType$: e, strings: t, values: o }), Z = Ce(1), z = Symbol.for("lit-noChange"), f = Symbol.for("lit-nothing"), Ot = /* @__PURE__ */ new WeakMap(), A = S.createTreeWalker(S, 129);
function Zt(e, t) {
...
const Ee = (e, t) => {
  ...
  let s, l = t === 2 ? "<svg>" : t === 3 ? "<math>" : "", a = N;
  for (let i = 0; i < o; i++) {
    const n = e[i];
    let d, m, h = -1, v = 0;
    for (; v < n.length && (a.lastIndex = v, m = a.exec(n), m !== null); ) v = a.lastIndex, a === N ? m[1] === "!--" ? a = Tt : m[1] !== void 0 ? a = Mt : m[2] !== void 0 ? (Gt.test(m[2]) && (s = RegExp("</" + m[2], "g")), a = C) : m[3] !== void 0 && (a = C) : a === C ? m[0] === ">" ? (a = s ?? N, h = -1) : m[1] === void 0 ? h = -2 : (h = a.lastIndex - m[2].length, d = m[1], a = m[3] === void 0 ? C : m[3] === '"' ? It : Pt) : a === It || a === Pt ? a = C : a === Tt || a === Mt ? a = N : (a = C, s = void 0);
    const b = a === C && e[i + 1].startsWith("/>") ? " " : "";
    l += a === N ? n + $e : h >= 0 ? (r.push(d), n.slice(0, h) + qt + n.slice(h) + $ + b) : n + $ + (h === -2 ? i : b);
  }
...
class G {
  constructor({ strings: t, _$litType$: o }, r) {
    ...
    this.parts = [];
    let l = 0, a = 0;
    const i = t.length - 1, n = this.parts, [d, m] = Ee(t, o);
    if (this.el = G.createElement(d, r), A.currentNode = this.el.content, o === 2 || o === 3) {
      const h = this.el.content.firstChild;
      h.replaceWith(...h.childNodes);
    }
    for (; (s = A.nextNode()) !== null && n.length < i; ) {
      if (s.nodeType === 1) {
        if (s.hasAttributes()) for (const h of s.getAttributeNames()) if (h.endsWith(qt)) {
          const v = m[a++], b = s.getAttribute(h).split($), y = /([.?@])?(.*)/.exec(v);
          n.push({ type: 1, index: l, name: y[2], strings: b, ctor: y[1] === "." ? Se : y[1] === "?" ? ze : y[1] === "@" ? Le : at }), s.removeAttribute(h);
        } else h.startsWith($) && (n.push({ type: 6, index: l }), s.removeAttribute(h));
        if (Gt.test(s.tagName)) {
          const h = s.textContent.split($), v = h.length - 1;
          if (v > 0) {
            s.textContent = st ? st.emptyScript : "";
            for (let b = 0; b < v; b++) s.append(h[b], q()), A.nextNode(), n.push({ type: 2, index: ++l });
            s.append(h[v], q());
          }
        }
      } else if (s.nodeType === 8) if (s.data === Wt) n.push({ type: 2, index: l });
      else {
        let h = -1;
        for (; (h = s.data.indexOf($, h + 1)) !== -1; ) n.push({ type: 7, index: l }), h += $.length - 1;
      }
      l++;
    }
  }
...
function P(e, t, o = e, r) {
  if (t === z) return t;
  let s = r !== void 0 ? o._$Co?.[r] : o._$Cl;
  const l = W(t) ? void 0 : t._$litDirective$;
  return s?.constructor !== l && (s?._$AO?.(!1), l === void 0 ? s = void 0 : (s = new l(e), s._$AT(e, o, r)), r !== void 0 ? (o._$Co ?? (o._$Co = []))[r] = s : o._$Cl = s), s !== void 0 && (t = P(e, s._$AS(e, t.values), s, r)), t;
}
class Ae {
  constructor(t, o) {
  ...
  u(t) {
    ...
    A.currentNode = s;
    let l = A.nextNode(), a = 0, i = 0, n = r[0];
    for (; n !== void 0; ) {
      if (a === n.index) {
        let d;
        n.type === 2 ? d = new Y(l, l.nextSibling, this, t) : n.type === 1 ? d = new n.ctor(l, n.name, n.strings, this, t) : n.type === 6 && (d = new Te(l, this, t)), this._$AV.push(d), n = r[++i];
      }
...
class Y {
  ...
  _$AI(t, o = this) {
    t = P(this, t, o), W(t) ? t === f || t == null || t === "" ? (this._$AH !== f && this._$AR(), this._$AH = f) : t !== this._$AH && t !== z && this._(t) : t._$litType$ !== void 0 ? this.$(t) : t.nodeType !== void 0 ? this.T(t) : ke(t) ? this.k(t) : this._(t);
  }
  O(t) {
  ...
  $(t) {
    const { values: o, _$litType$: r } = t, s = typeof r == "number" ? this._$AC(t) : (r.el === void 0 && (r.el = G.createElement(Zt(r.h, r.h[0]), this.options)), r);
    if (this._$AH?._$AD === s) this._$AH.p(o);
    else {
      const l = new Ae(s, this), a = l.u(this.options);
      l.p(o), this.T(a), this._$AH = l;
    }
  }
  _$AC(t) {
    let o = Ot.get(t.strings);
    return o === void 0 && Ot.set(t.strings, o = new G(t)), o;
  }
  k(t) {
...
class at {
  ...
  _$AI(t, o = this, r, s) {
    ...
    let a = !1;
    if (l === void 0) t = P(this, t, o, 0), a = !W(t) || t !== this._$AH && t !== z, a && (this._$AH = t);
    else {
      const i = t;
      let n, d;
      for (t = l[0], n = 0; n < l.length - 1; n++) d = P(this, i[r + n], o, n), d === z && (d = this._$AH[n]), a || (a = !W(d) || d !== this._$AH[n]), d === f ? t = f : t !== f && (t += (d ?? "") + l[n + 1]), this._$AH[n] = d;
    }
    a && !s && this.j(t);
  }
  j(t) {
...
Me?.(G, Y), (V.litHtmlVersions ?? (V.litHtmlVersions = [])).push("3.3.0");
const Pe = (e, t, o) => {
...
let j = class extends T {
  ...
  update(t) {
    const o = this.render();
    this.hasUpdated || (this.renderOptions.isConnected = this.isConnected), super.update(t), this._$Do = Pe(o, this.renderRoot, this.renderOptions);
  }
  connectedCallback() {
...
const Ie = F.litElementPolyfillSupport;
Ie?.({ LitElement: j });
...
`, Qt = Object.defineProperty, Ne = Object.defineProperties, Be = Object.getOwnPropertyDescriptor, He = Object.getOwnPropertyDescriptors, Nt = Object.getOwnPropertySymbols, Ue = Object.prototype.hasOwnProperty, De = Object.prototype.propertyIsEnumerable, Xt = (e) => {
  throw TypeError(e);
}, Bt = (e, t, o) => t in e ? Qt(e, t, { enumerable: !0, configurable: !0, writable: !0, value: o }) : e[t] = o, Q = (e, t) => {
  for (var o in t || (t = {}))
    Ue.call(t, o) && Bt(e, o, t[o]);
  if (Nt)
    for (var o of Nt(t))
      De.call(t, o) && Bt(e, o, t[o]);
  return e;
}, Jt = (e, t) => Ne(e, He(t)), c = (e, t, o, r) => {
  for (var s = r > 1 ? void 0 : r ? Be(t, o) : t, l = e.length - 1, a; l >= 0; l--)
    (a = e[l]) && (s = (r ? a(t, o, s) : a(s)) || s);
  return r && s && Qt(t, o, s), s;
}, Kt = (e, t, o) => t.has(e) || Xt("Cannot " + o), Re = (e, t, o) => (Kt(e, t, "read from private field"), t.get(e)), Ve = (e, t, o) => t.has(e) ? Xt("Cannot add the same private member more than once") : t instanceof WeakSet ? t.add(e) : t.set(e, o), Fe = (e, t, o, r) => (Kt(e, t, "write to private field"), t.set(e, o), o);
/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */
const je = { attribute: !0, type: String, converter: rt, reflect: !1, hasChanged: vt }, qe = (e = je, t, o) => {
  ...
  if (l === void 0 && globalThis.litPropertyMetadata.set(s, l = /* @__PURE__ */ new Map()), r === "setter" && ((e = Object.create(e)).wrapped = !0), l.set(o.name, e), r === "accessor") {
    ...
    return { set(i) {
      ...
      t.set.call(this, i), this.requestUpdate(a, n, e);
    }, init(i) {
      return i !== void 0 && this.C(a, void 0, e, i), i;
    } };
  }
  if (r === "setter") {
    const { name: a } = o;
    return function(i) {
      const n = this[a];
      t.call(this, i), this.requestUpdate(a, n, e);
    };
  }
  throw Error("Unsupported decorator location: " + r);
};
function u(e) {
  return (t, o) => typeof o == "object" ? qe(e, t, o) : ((r, s, l) => {
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const We = (e, t, o) => (o.configurable = !0, o.enumerable = !0, Reflect.decorate && typeof t != "object" && Object.defineProperty(e, t, o), o);
/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
...
var et, x = class extends j {
  constructor() {
    super(), Ve(this, et, !1), this.initialReflectedProperties = /* @__PURE__ */ new Map(), Object.entries(this.constructor.dependencies).forEach(([e, t]) => {
  ...
  attributeChangedCallback(e, t, o) {
    Re(this, et) || (this.constructor.elementProperties.forEach(
      (r, s) => {
        r.reflect && this[s] != null && this.initialReflectedProperties.set(s, this[s]);
      }
    ), Fe(this, et, !0)), super.attributeChangedCallback(e, t, o);
  }
  willUpdate(e) {
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const Ge = { ATTRIBUTE: 1 }, Ze = (e) => (...t) => ({ _$litDirective$: e, values: t });
let Ye = class {
  constructor(t) {
  }
  get _$AU() {
...
var ee = class extends x {
  constructor() {
    super(...arguments), this.hasSlotController = new Yt(this, "footer", "header", "image");
  }
  render() {
    return Z`
      <div
...
`;
const pt = /* @__PURE__ */ new Set(), M = /* @__PURE__ */ new Map();
let E, wt = "ltr", xt = "en";
const oe = typeof MutationObserver < "u" && typeof document < "u" && typeof document.documentElement < "u";
if (oe) {
...
function re(...e) {
  e.map((t) => {
    ...
    M.has(o) ? M.set(o, Object.assign(Object.assign({}, M.get(o)), t)) : M.set(o, t), E || (E = t);
  }), se();
}
function se() {
  oe && (wt = document.documentElement.dir || "ltr", xt = document.documentElement.lang || navigator.language), [...pt.keys()].map((e) => {
...
let Xe = class {
  ...
  getTranslationData(t) {
    var o, r;
    const s = new Intl.Locale(t.replace(/_/g, "-")), l = s?.language.toLowerCase(), a = (r = (o = s?.region) === null || o === void 0 ? void 0 : o.toLowerCase()) !== null && r !== void 0 ? r : "", i = M.get(`${l}-${a}`), n = M.get(l);
    return { locale: s, language: l, region: a, primary: i, secondary: n };
  }
  exists(t, o) {
    var r;
...
re(le);
var Je = le, ae = class extends Xe {
};
re(Je);
var _t = class extends x {
  constructor() {
    super(...arguments), this.localize = new ae(this);
  }
  render() {
    return Z`
...
_t.styles = [O, Qe];
var B = /* @__PURE__ */ new WeakMap(), H = /* @__PURE__ */ new WeakMap(), U = /* @__PURE__ */ new WeakMap(), dt = /* @__PURE__ */ new WeakSet(), J = /* @__PURE__ */ new WeakMap(), Ke = class {
  constructor(e, t) {
    this.handleFormData = (o) => {
      ...
      this.host.isConnected && !r && !a && typeof s == "string" && s.length > 0 && typeof l < "u" && (Array.isArray(l) ? l.forEach((i) => {
      ...
      this.form && !this.form.noValidate && ((r = B.get(this.form)) == null || r.forEach((a) => {
        this.setUserInteracted(a, !0);
      })), this.form && !this.form.noValidate && !s && !l(this.host) && (o.preventDefault(), o.stopImmediatePropagation());
    }, this.handleFormReset = () => {
      this.options.setValue(this.host, this.options.defaultValue(this.host)), this.setUserInteracted(this.host, !1), J.set(this.host, []);
    }, this.handleInteraction = (o) => {
      const r = J.get(this.host);
  ...
  hostConnected() {
    ...
    e && this.attachForm(e), J.set(this.host, []), this.options.assumeInteractionOn.forEach((t) => {
      this.host.addEventListener(t, this.handleInteraction);
    });
  }
  hostDisconnected() {
    this.detachForm(), J.delete(this.host), this.options.assumeInteractionOn.forEach((e) => {
  ...
  attachForm(e) {
    e ? (this.form = e, B.has(this.form) ? B.get(this.form).add(this.host) : B.set(this.form, /* @__PURE__ */ new Set([this.host])), this.form.addEventListener("formdata", this.handleFormData), this.form.addEventListener("submit", this.handleFormSubmit), this.form.addEventListener("reset", this.handleFormReset), H.has(this.form) || (H.set(this.form, this.form.reportValidity), this.form.reportValidity = () => this.reportFormValidity()), U.has(this.form) || (U.set(this.form, this.form.checkValidity), this.form.checkValidity = () => this.checkFormValidity())) : this.form = void 0;
  }
  detachForm() {
    if (!this.form) return;
    const e = B.get(this.form);
    e && (e.delete(this.host), e.size <= 0 && (this.form.removeEventListener("formdata", this.handleFormData), this.form.removeEventListener("submit", this.handleFormSubmit), this.form.removeEventListener("reset", this.handleFormReset), H.has(this.form) && (this.form.reportValidity = H.get(this.form), H.delete(this.form)), U.has(this.form) && (this.form.checkValidity = U.get(this.form), U.delete(this.form)), this.form = void 0));
  }
  setUserInteracted(e, t) {
    t ? dt.add(e) : dt.delete(e), e.requestUpdate();
  }
  doAction(e, t) {
    if (this.form) {
   ...
   */
  setValidity(e) {
    const t = this.host, o = !!dt.has(t), r = !!t.required;
...
function eo(e = "") {
  if (!mt) {
    ...
    if (o)
      Ht(o.getAttribute("data-shoelace"));
    else {
      const r = t.find((l) => /shoelace(\.min)?\.js($|\?)/.test(l.src) || /shoelace-autoloader(\.min)?\.js($|\?)/.test(l.src));
      let s = "";
      r && (s = r.getAttribute("src")), Ht(s.split("/").slice(0, -1).join("/"));
    }
  }
  return mt.replace(/\/$/, "") + (e ? `/${e.replace(/^\//, "")}` : "");
}
var oo = {
  name: "default",
  resolver: (e) => eo(`assets/icons/${e}.svg`)
}, ro = oo, Ut = {
  caret: `
  ...
  name: "system",
  resolver: (e) => e in Ut ? `data:image/svg+xml,${encodeURIComponent(Ut[e])}` : ""
}, lo = so, ao = [ro, lo], bt = [];
function io(e) {
  bt.push(e);
}
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const uo = (e, t) => e?._$litType$ !== void 0;
var D = Symbol(), K = Symbol(), ut, ht = /* @__PURE__ */ new Map(), _ = class extends x {
  constructor() {
  ...
  async resolveIcon(e, t) {
    ...
    try {
      if (r = await fetch(e, { mode: "cors" }), !r.ok) return r.status === 410 ? D : K;
    } catch {
      return K;
    }
    try {
      ...
      if (((o = l?.tagName) == null ? void 0 : o.toLowerCase()) !== "svg") return D;
      ut || (ut = new DOMParser());
      const i = ut.parseFromString(l.outerHTML, "text/html").body.querySelector("svg");
      return i ? (i.part.add("svg"), document.adoptNode(i)) : D;
    } catch {
      return D;
    }
  }
  ...
  disconnectedCallback() {
    super.disconnectedCallback(), no(this);
  }
  getIconSource() {
    const e = Dt(this.library);
    return this.name && e ? {
  ...
  async setIcon() {
    var e;
    const { url: t, fromLibrary: o } = this.getIconSource(), r = o ? Dt(this.library) : void 0;
    if (!t) {
      this.svg = null;
      return;
    }
    ...
    if (s || (s = this.resolveIcon(t, r), ht.set(t, s)), !this.initialRender)
      return;
    const l = await s;
    if (l === K && ht.delete(t), t === this.getIconSource().url) {
      if (uo(l)) {
        if (this.svg = l, r) {
...
c([
  u({ reflect: !0 })
], _.prototype, "library", 2);
c([
  kt("label")
], _.prototype, "handleLabelChange", 1);
c([
  kt(["name", "src", "library"])
], _.prototype, "setIcon", 1);
/**
 * @license
 * Copyright 2020 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */
const ie = Symbol.for(""), ho = (e) => {
  if (e?.r === ie) return e?._$litStatic$;
}, lt = (e, ...t) => ({ _$litStatic$: t.reduce((o, r, s) => o + ((l) => {
...
})(r) + e[s + 1], e[0]), r: ie }), Rt = /* @__PURE__ */ new Map(), po = (e) => (t, ...o) => {
  const r = o.length;
  let s, l;
  const a = [], i = [];
  let n, d = 0, m = !1;
  for (; d < r; ) {
    for (n = t[d]; d < r && (l = o[d], (s = ho(l)) !== void 0); ) n += s + t[++d], m = !0;
    d !== r && i.push(l), a.push(n), d++;
  }
  if (d === r && a.push(t[r]), m) {
    const h = a.join("$$lit$$");
    (t = Rt.get(h)) === void 0 && (a.raw = a, Rt.set(h, t = a)), o = i;
  }
  return e(t, ...o);
}, ot = po(Z);
/**
...
var p = class extends x {
  ...
  render() {
    const e = this.isLink(), t = e ? lt`a` : lt`button`;
    return ot`
      <${t}
        part="base"
        class=${nt({
...
`, w = class extends x {
  ...
  render() {
    const e = !!this.href, t = e ? lt`a` : lt`button`;
    return ot`
      <${t}
        part="base"
        class=${nt({
...
function ne() {
  if (!document.querySelector("#shoelace-card-styles")) {
    ...
    e.id = "shoelace-card-styles", e.textContent = go + `
` + fo, document.head.appendChild(e);
  }
}
function vo(e) {
...
async function wo(e) {
  try {
    const t = `${e}.plain.html`, o = new AbortController(), r = setTimeout(() => {
      o.abort();
    }, 1e4), s = await fetch(t, {
      mode: "cors",
    ...
    let l = await s.text();
    return l = l.replace(/src="\.\/media\//g, 'src="/media/'), l = l.replace(/src="media\//g, 'src="/media/'), l = l.replace(/src="\.\.\/media\//g, 'src="/media/'), l;
  } catch (t) {
    throw console.error("[shoelace-card] Plain HTML fetch error:", t), t;
  }
}
async function xo(e, t = 5e3) {
  return console.log(`[shoelace-card] Starting preload for: ${e}`), new Promise((o, r) => {
    const s = new Image(), l = setTimeout(() => {
      console.warn(`[shoelace-card] Image load TIMEOUT after ${t}ms: ${e}`), r(new Error(`Image load timeout: ${e}`));
    }, t);
    s.onload = () => {
      clearTimeout(l), console.log(`[shoelace-card] Image loaded successfully: ${e}`), o(s);
    }, s.onerror = () => {
      clearTimeout(l), console.error(`[shoelace-card] Image load ERROR: ${e}`), r(new Error(`Image load failed: ${e}`));
    }, console.log(`[shoelace-card] Setting img.src for: ${e}`), s.src = e;
  });
}
async function _o(e, t = 5e3) {
  const o = e.map((a) => a.image).filter(Boolean);
  if (o.length === 0)
    return [];
  console.log(`[shoelace-card] Preloading ${o.length} images...`);
  const r = o.map(
    (a) => xo(a, t).catch((i) => (console.warn(`[shoelace-card] Failed to preload image: ${a}`, i), null))
...
function ue(e) {
  e.addEventListener("click", Ao), document.addEventListener("keydown", So);
}
function I(e) {
  try {
    e._delegationHandler && document.removeEventListener("click", e._delegationHandler), e._keyHandler && (document.removeEventListener("keydown", e._keyHandler, { capture: !0 }), document.removeEventListener("keyup", e._keyHandler, { capture: !0 }), e.removeEventListener("keydown", e._keyHandler, { capture: !0 }), e.removeEventListener("keyup", e._keyHandler, { capture: !0 })), e._emergencyHandler && e.removeEventListener("click", e._emergencyHandler), e.parentNode && e.parentNode.removeChild(e);
  } catch {
    try {
      e.remove();
    } catch {
...
function zo(e) {
  const t = e.querySelector(".shoelace-card-modal-overlay"), o = e.querySelector(".shoelace-card-modal-close"), r = e.querySelector(".shoelace-card-modal-content");
  return {
    modal: !!e,
    overlay: !!t,
    closeButton: !!o,
...
function Vt(e, t) {
  ...
  try {
    const r = (s) => {
      s.preventDefault(), s.stopPropagation(), I(e);
    };
...
function Ft(e) {
  ...
  const o = (r) => {
    ...
    s && s.closest(`[data-modal-id="${t}"]`) === e && (r.preventDefault(), r.stopPropagation(), I(e), document.removeEventListener("click", o)), r.target === e && (I(e), document.removeEventListener("click", o));
  };
  document.addEventListener("click", o), e._delegationHandler = o;
}
function Lo(e) {
  let t = Vt(e);
  t || setTimeout(() => {
...
function To(e) {
  const t = (o) => {
    (o.key === "Escape" || o.code === "Escape" || o.keyCode === 27) && (o.preventDefault(), o.stopPropagation(), I(e), document.removeEventListener("keydown", t), document.removeEventListener("keyup", t));
  };
  document.addEventListener("keydown", t, { capture: !0 }), document.addEventListener("keyup", t, { capture: !0 }), e.addEventListener("keydown", t, { capture: !0 }), e.addEventListener("keyup", t, { capture: !0 }), e._keyHandler = t;
}
function Mo(e) {
  let t = 0;
  const o = () => {
    t++, t === 2 && I(e), setTimeout(() => {
      t = 0;
    }, 500);
  };
...
async function Io(e, t) {
    ...
    r = !0, e.innerHTML = `
      ...
      ">
        ...
        <p style="color: rgba(255, 255, 255, 0.9) !important;">
          Content is taking too long to load from: ${t}.plain.html
        </p>
        <button onclick="location.reload()" style="
          background: rgba(255, 255, 255, 0.2) !important;
          border: 1px solid rgba(255, 255, 255, 0.3) !important;
  ...
  try {
    const l = e.querySelector(".shoelace-card-modal-loading"), a = await wo(t);
    if (clearTimeout(s), r)
      return;
    if (a) {
      ...
      `, i.innerHTML = a, i.querySelectorAll("*").forEach((y) => {
        y.style.cssText += `
          color: white !important;
        ...
        `, y.tagName.match(/^H[1-6]$/) && (y.style.cssText += `
            font-weight: bold !important;
            margin-bottom: 1rem !important;
            font-size: ${2.5 - parseInt(y.tagName[1]) * 0.2}rem !important;
          `), y.tagName === "P" && (y.style.cssText += `
            margin-bottom: 1rem !important;
            line-height: 1.6 !important;
          `), y.tagName === "IMG" && (y.style.cssText += `
      ...
      const d = i.querySelector("h1"), m = d ? d.textContent : "Content";
      d && d.remove();
      const h = document.createElement("div");
      h.className = "shoelace-card-modal-header", h.style.cssText = `
      ...
      v.textContent = m, v.style.cssText = `
        color: white !important;
      ...
      b.className = "shoelace-card-modal-close", b.innerHTML = "ESC", b.setAttribute("aria-label", "Press ESC or click to close modal"), b.setAttribute("type", "button"), b.setAttribute("tabindex", "0"), b.style.cssText = `
        background: rgba(255, 255, 255, 0.2) !important;
      ...
      `, b.addEventListener("mouseenter", () => {
        b.style.background = "rgba(255, 255, 255, 0.3) !important", b.style.transform = "scale(1.05)";
      }), b.addEventListener("mouseleave", () => {
        b.style.background = "rgba(255, 255, 255, 0.2) !important", b.style.transform = "scale(1)";
      }), h.appendChild(v), h.appendChild(b), e.innerHTML = "", e.appendChild(h), e.appendChild(i);
    } else
...
async function Oo(e, t) {
  ...
  `;
  const l = document.createElement("sl-spinner");
  l.className = "shoelace-card-modal-loading", s.appendChild(l), r.appendChild(s), o.appendChild(r), document.body.appendChild(o), await he(o), zo(o).closeButton, Lo(o), To(o), Mo(o), setTimeout(() => {
    try {
      const i = o.querySelector(".shoelace-card-modal-close");
      i && i.focus();
    } catch (i) {
      debugLog("Focus error (non-critical):", i);
    }
  }, 150), await Io(s, e);
}
function No(e, t) {
  ...
  t.forEach((r, s) => {
    const l = ce(r, s + 1);
    o.appendChild(l);
  }), e.innerHTML = "", e.appendChild(o), e.classList.remove("loading"), ue(e);
}
async function Bo(e, t) {
  ...
  try {
    console.log("[shoelace-card] Preloading images..."), await _o(t), console.log("[shoelace-card] All images preloaded");
    const o = de(), r = document.createDocumentFragment();
    t.forEach((l, a) => {
      const i = ce(l, a + 1);
      r.appendChild(i);
    }), o.appendChild(r), e.innerHTML = "", e.appendChild(o), e.classList.remove("loading"), console.group("[DEBUG-COMPONENT] Shoelace Component Status"), console.log("[DEBUG-COMPONENT] Custom elements defined:", {
      "sl-card": !!customElements.get("sl-card"),
      "sl-button": !!customElements.get("sl-button"),
      "sl-icon": !!customElements.get("sl-icon")
    });
    const s = o.querySelectorAll("sl-card");
    console.log("[DEBUG-COMPONENT] sl-card elements found:", s.length), s.forEach((l, a) => {
      console.log(`[DEBUG-COMPONENT] sl-card ${a}:`, {
        tagName: l.tagName,
        shadowRoot: !!l.shadowRoot,
        innerHTML: l.innerHTML.substring(0, 100) + "...",
        computedDisplay: window.getComputedStyle(l).display,
        computedVisibility: window.getComputedStyle(l).visibility,
        offsetWidth: l.offsetWidth,
        offsetHeight: l.offsetHeight
      });
    }), console.groupEnd(), requestAnimationFrame(() => {
      const l = window.getComputedStyle(o).opacity;
      o.classList.add("loaded");
      const a = window.getComputedStyle(o).opacity;
      setTimeout(() => {
        if (window.getComputedStyle(o).opacity !== "1") {
          const n = `
          ...
          d.id = "shoelace-card-visibility-fix", d.textContent = n, document.head.appendChild(d);
        }
      }, 500);
    }), ue(e);
  } catch (o) {
    console.error("[shoelace-card] Image preloading failed:", o), No(e, t);
  }
}
function Ho(e) {
  e.innerHTML = `
...
async function qo(e) {
  try {
    ne(), await Uo();
    const t = vo(e), o = await yo(t), r = e.getAttribute("data-block-status"), s = e.getAttribute("data-block-name");
    e.innerHTML = "", e.classList.add("shoelace-card-block"), r && e.setAttribute("data-block-status", r), s && e.setAttribute("data-block-name", s), document.body.classList.contains("appear") || document.body.classList.add("appear");
    const l = e.closest(".section");
    l && l.style.display === "none" && (l.style.display = null, l.dataset.sectionStatus = "loaded"), await Bo(e, o);
  } catch {
    Ho(e);
  }
}
